...
//     title: 'Are you sure?',
//     text: status === 'pending'
//       ? 'Do you want to approve and submit this salary breakup?'
//       : 'Do you want to reject this salary breakup?',
//     icon: status === 'pending' ? 'question' : 'warning',
...
//     console.log("offffffffffffff",offerCTC);
...
//     // ✅ IMPORTANT: Pass the updated offer_ctc back to parent
//     if (onStatusChange) {
//       onStatusChange({
//         id: data.verification_id, // Make sure this matches the row ID
//         salary_breakup_id: isEditing ? existingSalaryBreakupId : newSalaryBreakupId,
//         offer_ctc: offerCTC, // ✅ Pass the updated CTC
//         status: status,
//         ...payload
//       });
//     }
...
//           <InfoRow label="PLANT" value={data?.PLANT || 'Head Office'} valueColor="text-blue-600" />
...
//             </button>
//       <button
//   onClick={() => confirmAndSubmit('pending')}
//   disabled={isSubmitting}
