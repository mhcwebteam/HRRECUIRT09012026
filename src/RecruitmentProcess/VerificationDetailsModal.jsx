...
import { X, Eye, Download, FileText, Check,CheckCircle, XCircle, Clock } from 'lucide-react';
...
const handleApprove = async (Document_Id,Verify_Id) => 
{
  ...
  {
    //console.log("DDDDDDdocment",documentId);
      ...
      <div className={`p-4 rounded-xl border-2 transition-all ${hasDocument
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {(docStatus==1)? (
              // Approved → Green Tick
              <span className="flex items-center justify-center w-9 h-9 bg-green-100 rounded-full">
