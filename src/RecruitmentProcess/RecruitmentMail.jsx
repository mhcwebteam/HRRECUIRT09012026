...
//       const response = await axios.post(`${API_BASE_URL}/send-recruitment-email`, {
//         case_id: caseId,
//         employee_email: email,
//         employee_name: rowData.RAISER || 'New Employee',
//         designation: rowData.MANPOWER_DESG || 'Employee',
//         department: rowData.DEPARTMENT || '',
//         plant: rowData.PLANT || '',
//         hr_email: 'hr@company.com' // You can make this dynamic or from user profile
//       }, {
//         headers: {
//           "Content-Type": "application/json",
//           Accept: "application/json",
...
//       Swal.fire({
//         title: 'Success!',
//         text: 'Recruitment email sent successfully',
//         icon: 'success',
//         confirmButtonText: 'OK'
//       });
...
//       Swal.fire({
//         title: 'Error!',
//         text: 'Failed to send recruitment email',
//         icon: 'error',
//         confirmButtonText: 'OK'
//       });
//     } finally {
...
//               variant="outlined"
//               size="small"
//               placeholder="Search manpower cases, users..."
//               value={searchText}
...
//             fontWeight: 500
//           }}>
//             {filteredData.length} of {data.length} manpower records
//           </Typography>
//         </Box>
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const shortlistedData = responseData.filter(row => 
          row.ACTION_STATUS?.toLowerCase() === 'shortlisted' || 
          row.STATUS?.toLowerCase() === 'shortlisted' ||
          row.CURRENT_STATUS?.toLowerCase() === 'shortlisted'
        );
        ...
        console.log(rowsWithId,"rowsWithIdrowsWithIdrowsWithId")
        
        setData(rowsWithId);
        setFilteredData(rowsWithId); // Initialize filtered data with shortlisted data
      } catch (error) {
        console.error("Error fetching participant data:", error);
      } finally {
        setLoading(false);
