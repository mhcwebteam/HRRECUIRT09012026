...
// import { X, FileText, Calendar, User, Building2, MapPin, CheckCircle2, Circle, Check } from 'lucide-react';
...
//         className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center gap-2"
//       >
//         <FileText size={20} />
//         Open Employee Checklist
//       </button>
