...
//   return (
//     <>
//       <header className="sticky top-0 z-50 bg-gradient-to-r from-[#0f3d32] to-[#145644] shadow-2xl">
//         <div className="flex items-center justify-between px-8 py-4">
          
//           {/* Logo Section */}
//           <div className="flex items-center gap-4">
//             <div className="relative">
//               <div className="w-14 h-14 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-500 p-[3px] shadow-lg">
...
//             <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 px-6 py-3 rounded-2xl border border-emerald-500/20 backdrop-blur-sm">
...
//             <div className="relative">
//               <button 
//                 className="relative p-3 rounded-full bg-slate-700 hover:bg-slate-600 transition-all duration-200 group"
//                 onClick={() => setNotificationCount(0)}
//               >
//                 <Bell className="w-5 h-5 text-slate-300 group-hover:text-emerald-400" />
//                 {notificationCount > 0 && (
//                   <span className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-br from-emerald-400 to-cyan-400 text-slate-900 text-xs font-bold rounded-full flex items-center justify-center shadow-lg animate-pulse">
//                     {notificationCount}
//                   </span>
//                 )}
//               </button>
...
//                 className="flex items-center gap-3 p-1.5 pr-4 rounded-full bg-slate-700 hover:bg-slate-600 transition-all duration-200 group"
//               >
//                 <div className="relative">
//                   <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-400 p-[2px] shadow-md">
//                     <img 
//                       src={profileImage} 
...
//                     />
//                   </div>
//                   <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-emerald-400 border-2 border-slate-800 rounded-full"></div>
//                 </div>
//                 <div className="hidden md:block text-left">
//                   <p className="text-sm font-semibold text-white">{token.employee}</p>
//                   <p className="text-xs text-slate-400">{token.Emp_Category}</p>
//                 </div>
//               </button>

       
//               {anchorMyAcc && (
//                 <div className="absolute right-0 mt-2 w-64  rounded-2xl shadow-xl border border-slate-700 overflow-hidden z-50">
...
//                       </div>
//                       <div>
//                         <p className="font-semibold text-white">{token.employee}</p>
//                         <p className="text-xs text-slate-400">{token.Email}</p>
//                       </div>
//                     </div>
//                   </div>
...
//                     </div>
//                     <span className="font-medium text-slate-200">View Profile</span>
//                   </button>
                  
//                   <button
//                     onClick={() => { handleCloseMyAcc(); userLogout(); }}
//                     className="w-full px-4 py-3 flex items-center gap-3 hover:bg-slate-700 transition-colors text-left border-t border-slate-600"
//                   >
//                     <div className="w-10 h-10 rounded-xl bg-slate-700 flex items-center justify-center">
...
//           <div className="bg-slate-800 rounded-3xl shadow-2xl max-w-md w-full overflow-hidden transform transition-all border border-slate-700">
...
//                   <div className="w-32 h-32 rounded-full bg-gradient-to-br from-emerald-500 to-cyan-500 p-[4px] shadow-xl">
//                     <img
...
//                     <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-200">
...
//                   </label>
//                 </div>
//                 <p className="text-sm text-slate-400 mt-3">Click the icon to upload new photo</p>
//               </div>
...
//             {/* Modal Footer */}
//             <div className="flex gap-3 p-6 bg-slate-700 border-t border-slate-600">
//               <button
//                 onClick={handleProfileClose}
//                 className="flex-1 px-6 py-3 rounded-xl font-semibold text-slate-300 bg-slate-600 border-2 border-slate-500 hover:bg-slate-500 transition-all duration-200"
//               >
//                 Cancel
//               </button>
//               <button
//                 onClick={handleProfileClose}
//                 className="flex-1 px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-emerald-500 to-cyan-500 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
//               >
//                 Save Changes
//               </button>
//             </div>
