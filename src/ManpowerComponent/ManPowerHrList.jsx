        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-amber-700 font-medium">Work in Progress</p>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-emerald-700 font-medium">Joined</p>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-blue-700 font-medium">Transfers</p>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-red-700 font-medium">Reverted</p>
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="relative flex-1 max-w-md">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200"
                  />
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead className="bg-gradient-to-r from-gray-300 to-gray-200 border-b border-gray-200">
                  <tr>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-12 border-r border-gray-300">S.NO</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-20 border-r border-gray-300">Plant</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-24 border-r border-gray-300">Case ID</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-24 border-r border-gray-300">Department</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-28 border-r border-gray-300">Designation</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-20 border-r border-gray-300">Status</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-20 border-r border-gray-300">EMP ID</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-32 border-r border-gray-300">Remarks</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-700 w-28">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {paginatedData.map((row, index) => (
                    <tr key={row.id} className="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200 group">
                      <td className="px-4 py-3 text-xs text-gray-900 font-medium border-r border-gray-200">
                      ...
                      <td className="px-4 py-3 text-xs font-semibold text-blue-600 hover:text-blue-800 cursor-pointer truncate border-r border-gray-200">
                        {row.CHILD_CASEID}
                      </td>
                      <td className="px-4 py-3 text-xs text-gray-900 border-r border-gray-200">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2 border border-gray-200 rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition-colors duration-200"
                  >
                    Previous
                  </button>
          ...
          {transferDialogOpen && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-y-auto">
                <div className="sticky top-0 bg-gradient-to-r from-blue-300 to-indigo-300 px-6 py-3 rounded-t-2xl">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <button
                      ...
                      className="p-2 hover:bg-white hover:bg-opacity-20 rounded-xl transition-colors duration-150"
                    >
                      <X className="w-5 h-5" />
                    </button>
                  </div>
                ...
                <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(95vh-112px)]">
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-gray-50 to-indigo-50 border border-gray-200 rounded-xl p-6">
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4  p-4 border-gray-500">
                        <div>
                        ...
                        {form.status === "Transfer" && (
                          <div>
                            ...
                            {errors.currPlant && <p className="text-red-500 text-sm mt-1">{errors.currPlant}</p>}
                          </div>
                        )}
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        {(form.status === 'Transfer' || form.status === 'Joined') && (
                          <div>
                            ...
                            />
                            {errors.depat && <p className="text-red-500 text-sm mt-1">{errors.depat}</p>}
                          </div>
                        )}
                        ...
                        {form.status === 'WIP' && (
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500"
                            />
                            {errors.extendedDate && <p className="text-red-500 text-sm mt-1">{errors.extendedDate}</p>}
                          </div>
                        )}
                ...
                <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 rounded-b-2xl">
                  <div className="flex items-center justify-end gap-3">
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
                      {loading ? (
                        <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-xl transition-colors duration-200"
                  ...
                  <div className="overflow-x-auto rounded-xl border border-gray-200 max-h-[calc(100vh-10px)]">
                    <table className="w-full border-collapse">
                      <thead className="bg-gray-100">
                        <tr>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">S.No</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">Status</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">EMP ID</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">Current Plant</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">Transfer Plant</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">Designation</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">Transfer Date</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">Updated By</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-r border-gray-300">Updated Date</th>
                          <th className="text-left px-3 py-3 text-xs font-semibold text-gray-700 border-b border-gray-300">Remarks</th>
                        </tr>
                      </thead>
                      <tbody>
