...
const handleEditSubmit = async () => {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <button
          ...
          className="px-3 py-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-md hover:from-blue-600 hover:to-blue-700 transition-all duration-200 flex items-center gap-1 shadow-md"
        >
          <Edit sx={{ fontSize: 16 }} />
          Edit
        </button>
  ...
  return (
    <>
      ...
      <div className="p-6 shadow-md rounded-lg min-h-screen max-w-7xl w-full mx-auto
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-y-auto">
              ...
              <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(95vh-112px)]">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-indigo-50 border border-gray-200 rounded-xl p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Update Requirements</h3>
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-3 pt-3">
                    ...
                    <div>
                      ...
                      {errors.total_requirement && (
                        <p className="text-red-500 text-sm mt-1">{errors.total_requirement}</p>
                      )}
                    </div>
              ...
              <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 rounded-b-2xl">
                <div className="flex items-center justify-end gap-3">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl hover:from-blue-500 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl"
                  >
                    {loading ? (
        ...
        <Paper sx={{
          ...
          <Box
            ...
            <button
              ...
              className="flex items-center  px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-500 transition-all duration-200 shadow-md hover:shadow-lg"
            >
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          ...
                          {modalErrors.plantCode && (
                            <p className="text-red-500 text-sm mt-1">{modalErrors.plantCode}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {modalErrors.selectedDept && (
                            <p className="text-red-500 text-sm mt-1">{modalErrors?.selectedDept}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {modalErrors.selectedDesignation && (
                            <p className="text-red-500 text-sm mt-1">{modalErrors.selectedDesignation}</p>
                          )}
                        </div>
                      </div>

                      <div className="grid grid-cols-3 gap-4 mb-3 pt-3">
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                            Total Requirement <span className="text-red-500">*</span>
                          </label>
                          ...
                          {modalErrors.totalReq && (
                            <p className="text-red-500 text-sm mt-1">{modalErrors.totalReq}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {modalErrors.availabilityAdd && (
                            <p className="text-red-500 text-sm mt-1">{modalErrors.availabilityAdd}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            value={actualReqAdd}
                            readOnly
                            className="w-full mt-1 px-4 py-3 border-2 border-blue-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-100 transition duration-200 bg-gray-100"
                          />
                        </div>
                      </div>
                    </div>
...
//                             value={plantCode}
//                             onChange={handlePlantCodeChange}
//                             className="w-full mt-1 px-4 py-3 border-2 border-blue-300 rounded-xl focus:outline-none focus:ring-2  transition duration-200 bg-white text-gray-900"
//                             required
//                           >
//                             <option value="">Select Plant</option>
//                             {plantOptions.map((plant, idx) => (
...
//                             value={selectedDesignation}
//                             onChange={(e) => setSelectedDesignation(e.target.value)}
//                             className="w-full mt-1 px-4 py-3 border-2 border-blue-300 rounded-xl focus:outline-none focus:ring-2 transition duration-200 bg-white"
//                             required
//                           >
//                             {desgList?.map((desg, idx) => (
//                               <option key={idx} value={desg.DESIG}>
